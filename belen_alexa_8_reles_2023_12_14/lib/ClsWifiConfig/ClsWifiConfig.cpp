...
bool ClsWifiConfig::connectWS()
{
    ...
    // TODO uncoment this block for static ip
...
void ClsWifiConfig::setup_MdnsHostName()
{
    // Initialize mDNS
    if (!MDNS.begin(m_WiFiHostName))
    { // Set the hostname to "<m_WiFiHostName>.local"
