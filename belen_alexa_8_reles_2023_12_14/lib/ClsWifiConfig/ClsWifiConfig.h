...
public:
    ...
    bool set_ConfigRelaysJsonString(String ConfigRelaysJsonString);
   ...
   String relaysJsonFileRead();
   void relaysJsonFileSave(String relaysJson);
   String relaysJson();
